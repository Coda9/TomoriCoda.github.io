        ...
        */
        ...
        r.prototype.Q = function (e) {
            ...
            var j = function () {
                ...
                P = function (e) {
                    if (!u.attr(j, "disabled"))
                    return "" == v.nick || "匿名" == v.nick || "Anonymous" == v.nick ? (alert("请输入昵称！"),
                    void _.nick.focus()) : "" == v.mail ? (alert("请输入邮箱！"),
                    void _.mail.focus()) : "" == v.comment ? (alert("请输入内容！"),
                    void _.comment.focus()) : (v.nick = v.nick || "匿名",
                    v.nick = v.nick || "Anonymous",
                    void (t.notify || t.verify ? U(P) : P()));
                t.alert.show({
                    type: 0,
